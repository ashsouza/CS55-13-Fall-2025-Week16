...
const Tab1: React.FC = () => {
  ...
  const dataURL = "https://dev-cs5513-fall2025-ashsouza.pantheonsite.io/wp-json/twentytwentyone-child/v1/largeparrots";
  ...
  return (
    <IonPage>
      <IonHeader>
        <IonToolbar>
          <IonTitle className="ion-title">Large Parrots</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent fullscreen>
        <IonHeader collapse="condense">
          <IonToolbar>
            <IonTitle size="large" className="extra-large-title">Large Parrot Products</IonTitle>
          </IonToolbar>
        </IonHeader>
